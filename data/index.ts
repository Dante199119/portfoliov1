export const navItems = [
  ...
  export const gridItems = [
  ...
  
    {
      ...
      className: "lg:col-span-4 lg:row-span-2 md:col-span-3 md:row-span-2",
    ...
    },
    {
      ...
      description: "",
      className: "lg:col-span-1 lg:row-span-1 md:col-span-3 md:row-span-1",
      imgClassName: " h-[380px]",
      titleClassName: "justify-center md:max-w-full max-w-60 text-center text-base items-center my-4 bottom-5",
      img: "",
      spareImg: "",
    },
  ];
